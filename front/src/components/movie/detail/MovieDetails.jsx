...
const MovieDetailPage = () => {
  ...
  const handleLikeChange = (liked, likesCount) => {
    ...
    setMovie((prev) => ({
      ...
      likesCount: likesCount || (liked ? (prev.likesCount || 0) + 1 : Math.max(0, (prev.likesCount || 0) - 1))
    }));
  ...
  return (
    <div className="w-full min-h-screen bg-[#171717] text-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* تصویر مخصوص موبایل - در وسط کادر (اصلاح شده) */}
        <div className="lg:hidden mb-6 flex justify-center">
          <div className="w-64 h-64 max-w-full rounded-xl overflow-hidden shadow-xl border border-gray-700">
            <img
            ...
            <div className="lg:w-2/3 flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="bg-[#374151] px-5 py-3 rounded-full shadow-sm inline-block">
              ...
              <div className="mt-auto">
                <div className="flex items-center justify-between p-6 bg-[#374151] rounded-xl">
                  {movie.creator && (
